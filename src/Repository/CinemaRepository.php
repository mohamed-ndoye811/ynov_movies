...
class CinemaRepository extends ServiceEntityRepository
{
    ...
    /**
     * Récupère tous les cinemas.
     *
     * @return Cinema[] Renvoie un tableau de cinemas.
     */
    public function findAllCinemas(int $page = 1, int $pageSize = 10): array
    {
    ...
    public function findOneByUid($value): ?Cinema
    {
        return $this->createQueryBuilder('c')
            ->andWhere('c.uid = :val')
            ->setParameter('val', $value)
